package com.sccodefactory.scbookkeeping.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.sccodefactory.scbookkeeping.service.EmailAlreadyUsedException ||
            ex instanceof com.sccodefactory.scbookkeeping.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.sccodefactory.scbookkeeping.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(
            ...
            "io.",
            "de.",
            "com.sccodefactory.scbookkeeping"
        );
    }
}
